...
To access the preference center, got to `Your Settings` > `Profile Center`

![Navigate to Preferences page](/assets/content/get-to-preferences.png)
...
You can enter a mobile/cell number to receive SMS notifications. These notifications are sent immediately when publishing content.
