...
4. Upload an image - *This image will be shown on your article and as a thumbnail on email notifications*
...
6. Use the tag multi-select fields to tag your content accordingly - See [Tagging](tagging) for more information about tags
...
>- Approved - If an article is marked as approved it will be published immediately, if not an email will be sent to your content approvers

9. Once complete, click `Publish` or `Submit for Approval` - *This button is dynamic based on whether or not the article has been approved*
See [Approval](approval) or more information on approving content 
