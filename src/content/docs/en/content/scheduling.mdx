...
3. Select the date you would like the content to be made available from
...
![Schedule Popup - Expiry](/assets/content/schedule-modal-expiry.png)

3. Check the `Set Expiry Date` box
4. Select the date you would like the content to expire and therefore no longer be visible in Viewpoint
